...
{
    public class BtcTurkClientOptions : BaseRestClientOptions
    {
        public static BtcTurkClientOptions Default { get; set; } = new BtcTurkClientOptions();


        private BtcTurkSingleClientOptions _singleApiOptions = new BtcTurkSingleClientOptions(BtcTurkApiAddresses.Default.ApiAddress)
        {
